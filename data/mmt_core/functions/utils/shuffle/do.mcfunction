...
function mmt_core:utils/len/do with storage mcmmt:core_utils shuffle
execute store result score last core_utils_shuffle run data get storage mcmmt:core_utils len.length 1.0
