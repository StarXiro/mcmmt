...
data modify storage mcmmt:core_utils for_each set value {list: [], macro_bag:{ args: {index: 0, object: {}, extra_index: []}, loop_body: ""}, stack_bag: {index: 0, loop_body: "", list: []}, depth: 0, stack: [], examples:{list: []}}
