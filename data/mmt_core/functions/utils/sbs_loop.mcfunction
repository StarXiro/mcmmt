...
execute as @r store result storage mcmmt:core_utils SBSconfig.score int 1 run scoreboard players get @r core_utils_sbs_sort
#loop ++
...
#main
$execute as @e if score @s core_utils_sbs_temp = @s core_utils_sbs_sort run scoreboard players set $(loop_cnt) core_utils_sbs_rank $(score)
#remove
