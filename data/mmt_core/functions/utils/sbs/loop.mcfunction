...
#generate
execute as @e[scores={core_utils_sbs_temp=-2147483648..2147483647}] if score @s core_utils_sbs_temp = @s core_utils_sbs_sort run function mmt_core:utils/sbs/generate with storage mcmmt:core_utils SBSconfig

#remove
execute if score loop_cnt core_utils_sbs_sort < loop_max core_utils_sbs_sort run function mmt_core:utils/sbs/loop