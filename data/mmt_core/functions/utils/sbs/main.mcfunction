...
scoreboard players set @e[scores={core_utils_sbs_prank=-2147483648..2147483647}] core_utils_sbs_prank 0
scoreboard players set loop_cnt core_utils_sbs_sort 1
scoreboard players set loop_index core_utils_sbs_sort 0
