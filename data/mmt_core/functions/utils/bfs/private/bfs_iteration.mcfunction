...
# make color
function mmt_core:utils/bfs/private/get_color

# action on each ptr
execute as @e[type=minecraft:marker, tag=cu_bfs_ptr, tag=!cu_bfs_alr, tag=!cu_bfs_badptr] at @s run function mmt_core:utils/bfs/private/bfs_action
