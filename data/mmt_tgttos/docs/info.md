...
|**launch.mcfunction**|single|玩家传送与状态修改<br>游戏数据更新<br>记分板展示<br>循环开始|on_tick.mcfunction<br>on_5tick.mcfunction<br>game_process/one_use/prepare.mcfunction<br>game_process/intro.mcfunction|/|
