...
function mmt_tgttos:game_process/loop/teamname_set with storage mcmmt:tgttos
function mmt_tgttos:game_process/one_use/complete_action/team_check with storage mcmmt:tgttos teamcheck
