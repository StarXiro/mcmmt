...
$execute if score gameprocess tgttos matches 4 run execute if score second tgttos matches 0..9 run scoreboard players display name 剩余时间 tgttos_scoreboard_$(team) [{"text":"返回大厅: ","color":"red"},{"color":"white","text":"$(minute)"},{"text":":0","color":"white"},{"color":"white","text":"$(second)"}]
$execute if score gameprocess tgttos matches 4 run execute if score second tgttos matches 10.. run scoreboard players display name 剩余时间 tgttos_scoreboard_$(team) [{"text":"返回大厅: ","color":"red"},{"color":"white","text":"$(minute)"},{"text":":","color":"white"},{"color":"white","text":"$(second)"}]