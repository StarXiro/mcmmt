...
execute as @r store result storage creeperandcat game_count int 1 run scoreboard players get game_count CACconfig
...
execute as @r store result storage creeperandcat second1 int 1 run scoreboard players get second1 CACconfig
