data modify storage mcmmt:dynaball macro_bag.len.list set from storage mcmmt:dynaball msg_list.no_source_death
...
data modify storage mcmmt:dynaball macro_bag.get.path set value "msg_list.no_source_death"
