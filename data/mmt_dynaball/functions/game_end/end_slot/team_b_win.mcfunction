...
$function mmt_dynaball:scores/add_ts {team: "$(team_b)", type: "win"}

$data modify storage mcmmt:dynaball temp2 set value $(team_data)
data modify storage mcmmt:dynaball macro_bag.end_slot_title.team set from storage mcmmt:dynaball temp2.b_data.display
data modify storage mcmmt:dynaball macro_bag.end_slot_title.tc set from storage mcmmt:dynaball temp2.b_data.color
