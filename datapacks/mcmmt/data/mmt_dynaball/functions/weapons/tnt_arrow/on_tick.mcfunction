...
execute as @e[type=minecraft:tnt, tag=dynaball_tnt_fly, tag=tnt_team_a] at @s if entity @p[distance=..0.8, tag=team_b, tag=player_dynaball] run function mmt_dynaball:weapons/tnt_arrow/stuck_tnt
execute as @e[type=minecraft:tnt, tag=dynaball_tnt_fly, tag=tnt_team_b] at @s if entity @p[distance=..0.8, tag=team_a, tag=player_dynaball] run function mmt_dynaball:weapons/tnt_arrow/stuck_tnt
